      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-2 space-y-2 border-t border-cyber-blue/20 pt-4">
            ...
            <button className="w-full text-left text-sm font-medium tracking-wider text-gray-300 hover:text-cyber-blue transition-all duration-300 py-3 px-4 rounded-lg hover:bg-cyber-blue/5 flex items-center">
              <svg
                className="w-5 h-5 text-cyber-blue mr-2"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
